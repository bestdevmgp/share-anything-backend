...
fn get_device_confirm_translations(lang: &str) -> &'static DeviceConfirmTranslations {
    match lang {
        "ko" => &DeviceConfirmTranslations {
            ...
            location_label: "위치",
            time_label: "로그인 시간",
            note: "회원님이 로그인한 것이 맞나요? 로그인 하지 않았다면 지금 바로 \"아니요\"를 눌러주세요.",
            revoke_button: "아니요, 내가 로그인 하지 않았습니다.",
        ...
        "ja" => &DeviceConfirmTranslations {
            ...
            location_label: "場所",
            time_label: "ログイン時刻",
            note: "ご本人によるログインですか？身に覚えがない場合は、すぐに「いいえ」を押してください。",
            revoke_button: "いいえ、私はログインしていません。",
        ...
        "zh-CN" => &DeviceConfirmTranslations {
            ...
            location_label: "位置",
            time_label: "登录时间",
            note: "是您本人登录吗？如果不是您本人，请立即点击\"不是\"。",
            revoke_button: "不是，我没有登录。",
        ...
        "zh-TW" => &DeviceConfirmTranslations {
            ...
            location_label: "位置",
            time_label: "登入時間",
            note: "是您本人登入嗎？如果不是您本人，請立即點擊「不是」。",
            revoke_button: "不是，我沒有登入。",
        ...
        _ => &DeviceConfirmTranslations {
            ...
            note: "Was this you? If not, click \"No\" right away.",
            revoke_button: "No, I didn't sign in.",
