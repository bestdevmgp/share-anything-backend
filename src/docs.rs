...
use crate::models::{
    ...
    cli::{
        ...
        CliDownloadUrlResponse, CliDownloadCompleteRequest,
...
#[openapi(
    paths(
        ...
        crate::handlers::cli::cli_download_url,
        crate::handlers::cli::cli_download_complete,
    ...
    components(
        schemas(
            ...
            CliCompleteFileInfo,
            CliCompletedPart,
            CliDownloadUrlResponse,
            CliDownloadCompleteRequest,
            CliMeResponse,
